...
import AdvancedTasksVisualizer from './AdvancedTasksVisualizer';
...
const Navbar = () => {
  ...
  <div className="flex items-center flex-shrink-0 text-white mr-6">
    ...
    <Route path='/' element={<AdminView/>}></Route>
      ...
      <Route path='/AdvancedTaskVisualizer' element={<AdvancedTasksVisualizer/>}></Route>

      <Route path='/TasksAnalytics' element={<TasksAnalytics/>}></Route>
