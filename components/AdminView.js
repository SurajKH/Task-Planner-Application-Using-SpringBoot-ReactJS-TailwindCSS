...
const AdminView = () => {
    ...
    //lets consider the concept of conditional rendering over here.
      ...
      // lets update the data from the form,then apply the conditional rendering to redirect them to a new page.
       ...
       const handleSubmit=(e)=>
       {
        ...
        if(username==admin_username && admin_password==userPassword && stateView=="TaskVisualizer")
        {
           // console.log("Authentication Successfull");
           //now lets redirect to a new Page.
         
          navigate('/taskVisualizer');

        }
        else if(username==admin_username && admin_password==userPassword && stateView=="NewTask")
        {
           // console.log("Authentication Successfull");
           //now lets redirect to a new Page.
          navigate('/newTask');
  ...
  return (
    <React.Fragment>
    {/* <BrowserRouter> */}
    <h2 class='text-center text-lg border-spacing-4 border-black mt-12'>Admin  <FontAwesomeIcon icon={faUser} /> </h2>
  ...
  <div class="flex">
   ...
   <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onChange={(e)=>{
    ...
    setStateView(e.target.value);
      ...
      <option selected>Choose a Particular Scope</option>
      <option value="TaskVisualizer">Task Visualizer</option>
      <option value="NewTask">Add a New Task</option>
      <option value="AboutView">About Us</option>
      <option value="AdvancedTaskVisualizer">Advanced Task Visualizer</option>
      <option value="TasksAnalytics">
        Tasks Analytics
      </option>
